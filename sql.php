...
list($is_group, $is_func, $is_count, $is_export, $is_analyse, $is_explain,
    $is_delete, $is_affected, $is_insert, $is_replace, $is_show, $is_maint) = PMA_getDisplayPropertyParams(
            $sql_query, $is_select
        );
...
if ((0 == $num_rows && 0 == $unlim_num_rows) || $is_affected) {
    ...
    $updatableView = trim($analyzed_sql[0]['select_expr_clause']) == '*'
    ...
    do {
        ...
        if (isset($sql_data['valid_sql'][$sql_no])) {
            ...
            list($is_group, $is_func, $is_count, $is_export, $is_analyse,
                ...
                $is_show, $is_maint) = PMA_getDisplayPropertyParams(
