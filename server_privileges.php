...
if (isset($_REQUEST['adduser_submit']) || isset($_REQUEST['change_copy'])) {
    ...
    if (PMA_DBI_fetch_value($sql) == 1) {
        ...
        list($create_user_real, $create_user_show, $real_sql_query, $sql_query) = PMA_getSqlQueriesForDisplayAndAddUser(
 ...
 * some standard links
 */
list($link_edit, $link_revoke, $link_export) = PMA_getStandardLinks($conditional_class);
