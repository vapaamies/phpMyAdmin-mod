    ...
    for ($i = 0; $i < $size; $i++) {
        ...
        if (isset($chain) && !$seen_end_of_table_ref
            ...
            if ($size_chain > 1) {
                ...
                $subresult['select_expr'][$current_select_expr]['expr'] = $subresult['select_expr'][$current_select_expr]['table_name']
            ...
            if ($size_chain > 2) {
                ...
                $subresult['select_expr'][$current_select_expr]['expr'] = $subresult['select_expr'][$current_select_expr]['db']
                    . '.' . $subresult['select_expr'][$current_select_expr]['expr'];
            } // end if ($size_chain > 2)
            unset($chain);
        ...
        if (isset($chain) && $seen_from && $save_table_ref
            ...
            if ($size_chain > 1) {
                ...
                $subresult['table_ref'][$current_table_ref]['expr'] = $subresult['table_ref'][$current_table_ref]['db']
