...
class PMA_RecentTable
{
    ...
    public function __construct()
    {
        if (strlen($GLOBALS['cfg']['Server']['pmadb'])
            ...
            $this->_pmaTable = PMA_Util::backquote($GLOBALS['cfg']['Server']['pmadb']) . "."
    ...
    public function getFromDb()
    {
        ...
        $sql_query = " SELECT `tables` FROM " . $this->_pmaTable .
    ...
    public function saveToDb()
    {
        ...
        $sql_query = " REPLACE INTO " . $this->_pmaTable . " (`username`, `tables`)" .
                " VALUES ('" . $username . "', '"
